const toast = (type,info)=>{
    let timer;
    let success =`<div class="toast fixed top-20 right-10 flex item-center bg-white rounded border shadow-md p-2">
    ...
    <div class="ml-2 text-green-500">${info}</div>
    </div>`;

    let failed = `<div class="toast fixed top-20 right-10 flex item-center bg-white rounded border shadow-md p-2">
    ...
    <div class="ml-2 text-red-500">${info}</div>
    </div>`
